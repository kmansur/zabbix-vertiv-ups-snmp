...
For example, project version `1.3.1` is exported as `vendor.version: 1.3-1`. The release workflow validates the tag against `VERSION` and validates both template exports before publishing the release archive.
