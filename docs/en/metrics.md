...
The table below documents the fixed items included in the current template. OID availability can vary by UPS model and management card.
...
The template discovers input, output and bypass line tables using UPS-MIB table columns.

### UPS input lines discovery

- Discovery key: `ups.input.lines.discovery`
- Discovery OID: `discovery[{#UPSINPUTVOLTAGE},1.3.6.1.2.1.33.1.3.3.1.3]`

Prototypes:

| Key | Item prototype | OID | Unit |
| --- | --- | --- | --- |
...
- Discovery key: `ups.output.lines.discovery`
- Discovery OID: `discovery[{#UPSOUTPUTVOLTAGE},1.3.6.1.2.1.33.1.4.4.1.2]`
...
- Discovery key: `ups.bypass.lines.discovery`
- Discovery OID: `discovery[{#UPSBYPASSVOLTAGE},1.3.6.1.2.1.33.1.5.3.1.2]`
