...
Por exemplo, a versão `1.4.1` do projeto é exportada como `vendor.version: 1.4-1`. O workflow de release valida a tag contra `VERSION` e valida os dois exports antes de publicar o pacote da release.
